...
namespace FxEngine
{
    public static class StaticHelpers
    {
        ...
        public static Vector4 ToVector4(this Vector4d z)
        {
            return new Vector4((float)z.X, (float)z.Y, (float)z.Z, (float)z.W);
        }

        public static Matrix4 ToMatrix4(this Matrix4d z)
        {
            Matrix4 ret = new Matrix4();
            ret.Row0 = z.Row0.ToVector4();
            ret.Row1 = z.Row1.ToVector4();
            ret.Row2 = z.Row2.ToVector4();
            ret.Row3 = z.Row3.ToVector4();
            return ret;
        }

        public static float ParseFloat(this string z) => float.Parse(z.Replace(",", "."), CultureInfo.InvariantCulture);
        public static float ToFloat(this string z) => ParseFloat(z);

        

        public static double signed_area(this Vector2d[] polygon)
        {
            double area = 0.0;
        ...
        public static bool pnpoly(this Vector2d[] verts, double testx, double testy)
        {
