namespace FxEngine.Loaders.Collada
{
    public class AnimatedModelShader : ShaderProgram
    {
        ...
        public AnimatedModelShader() :
            base(VERTEX_SHADER, FRAGMENT_SHADER, new string[] {"in_position", "in_textureCoords", "in_normal", "in_jointIndices",
                    "in_weights" })
        {
            base.storeAllUniformLocations(new Uniform[] { projectionViewMatrix, diffuseMap, lightDirection, jointTransforms });
            connectTextureUnits();
        }
