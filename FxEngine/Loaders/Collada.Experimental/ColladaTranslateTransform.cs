...
{
    public class ColladaTranslateTransform : ColladaTransform
    {
        public Vector3 Vector;
        public static ColladaTransform Parse(XElement titem, ColladaParseContext ctx)
        {

            ColladaTranslateTransform ret = new ColladaTranslateTransform();
        ...
        {
            var tr = Matrix4.CreateTranslation(Vector);
            tr.Transpose();
            return tr;
        }
    }
